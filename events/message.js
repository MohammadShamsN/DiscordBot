module.exports = (client, message) => {
  ...
  if ( message.author.id  == `460515690760241153` && message.channel.id == `867084733753327636` ) {
  ...
  if ( message.author.id == `582716832528465920` && message.channel.id == `867084733753327636` ) {
