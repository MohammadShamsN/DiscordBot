...
exports.run = async (client, message) => {
  message.channel.send(
      new MessageEmbed()
        ...
        .setTitle("Follow Me On Our Social Media")
        .setColor("CD00FF")
        .setThumbnail("https://media.discordapp.net/attachments/825067075818356796/893790112868098128/PicsArt_10-02-12.21.31.png")
        ...
        .addField("<a:Discord2:871469574434988072> Discord", "https://discord.gg/suMV5Upuah")
    );
};